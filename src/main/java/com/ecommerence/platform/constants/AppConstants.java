...
public class AppConstants {
    public static final String PRODUCT_CREATED_SUCCESSFULLY_MESSAGE = "Product %s created successfully";
    public static final String PRODUCT_UPDATED_SUCCESSFULLY_MESSAGE = "Product updated successfully";
    public static final String PRODUCT_DELETED_SUCCESSFULLY_MESSAGE = "Product deleted successfully";
